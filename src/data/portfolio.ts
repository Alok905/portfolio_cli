...
✨ I love writing clean, optimized code and solving problems using data structures and algorithms.`,
  ...
  experience: [
    {
      ...
      description:
        "Developing employee portal features including hierarchy mapping, leave application, and workflows. Building RESTful APIs and optimizing backend performance.",
    ...
    },
    {
      ...
      description:
        "Built SPA frontend and created REST APIs, integrated frontend & backend, designed responsive UI, debugged and optimized code.",
      technologies: [
        "React.js",
        "Express.js",
        "MongoDB",
  ...
  skills: {
    ...
    networkingProtocols: ["GPON", "TCP/IP", "Computer Networks", "VLAN"],
    devopsTools: [
      "AWS (EC2, S3, IAM, CLI)",
      "Linux",
      "Bash Scripting",
